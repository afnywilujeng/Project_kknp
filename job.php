...
include("config.php");
 ...
 try {
    ...
    $key = array(
       ...
       new xmlrpcval('expected_employees','string') , 
       new xmlrpcval('no_of_employee', 'string'),
       new xmlrpcval('no_of_recruitment','string'),
 ...
 <section id="main" class="column"><!-- end of stats article --><!-- end of content manager article -->
    ...
    <article class="module width_full">
       <header><h3>Job Positions</h3></header>
                ...
                <table class="tablesorter">
                   ...
                   <?php foreach ($myCalenders as $mc) { ?>
                      ...
                      <tr>
                         ...
                         <td><?php
                            $user = $m['department_id']->scalarval()[1]->scalarval();
                            echo $user[1]->scalarval();
                            ?></td>
                          <td><?php echo $m['expected_employees']->scalarval() ?></td>
                          <td><?php echo $m['no_of_employee']->scalarval() ?></td>
                          <td><?php echo $m['no_of_recruitment']->scalarval() ?></td>
                          <td><?php echo $m['state']->scalarval() ?></td>
                      </tr>
                   <?php } ?>
                   </tbody>
                </table>
